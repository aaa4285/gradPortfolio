(function ($) {
  ...
  $(window).on('load', function () {
	...
	if ($('.portfolio-container2').length > 0) {
	...
	if ($('.portfolio-container3').length > 0) {
    var portfolioIsotope2 = $('.portfolio-container3').isotope({
        itemSelector: '.portfolio-item'
      });
      $('#portfolio-flters3 li').on( 'click', function() {
        $("#portfolio-flters3 li").removeClass('filter-active');
        $(this).addClass('filter-active');
