...
OO님 환영합니다. <button type="button" onclick="location.href='/logout'" class="btn btn-secondary btn-rounded waves-effect waves-light" style="font-size: 11px;padding: 1px 5px;">로그아웃</button>
</div>
<div class="container title ft-theme">
