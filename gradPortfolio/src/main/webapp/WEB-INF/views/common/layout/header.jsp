...
<c:choose>
	...
	<c:otherwise>
		<button type="button" onclick="location.href='/login'" class="btn btn-secondary btn-rounded waves-effect waves-light" style="font-size: 11px;padding: 1px 5px;">로그인</button>
	</c:otherwise>
</c:choose>
<c:if test="${sessionScope.userSession.displayName} ne null">
