...
$(document).ready(function() {
    ...
    $("#deleteBoard").click(function(){
    	...
    	com.confirm(option, function() {
    		loder_show();
    		location.href='/board/delete/${detail.board_id}';
    	});
    });

    $("#updateBoard").click(function(){
    	loder_show();
    	location.href='/board/update/${detail.board_id}';
    });
	...
	<section class="blog-posts-area section-gap">
		<div class="container">
			...
			<c:if test="${sessionScope.userSession.id eq detail.writer}">
				<button type="button" class="btn btn-primary btn-sm" id="deleteBoard" style="margin-left: 5px; float:right">삭제</button>
				<button type="button" class="btn btn-primary btn-sm" id="updateBoard" style="float:right;">수정</button>
			</c:if>
		</div>
	</section>
